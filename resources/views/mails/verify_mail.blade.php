...
<body style="background-color: #e9ecef;">
  ...
  <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
    Welcome to {{ config("app.name") }} {{ $mail }}, please confirm your e-mail address ...
  </div>
  <!-- end preheader -->
          ...
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
              <a href="{{ route("index") }}" target="_blank" style="display: inline-block;">
                <img src="{{ route("index") . "/assets/img/favicon.png" }}" alt="Logo" border="0" width="48" style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
              </a>
            </td>
          </tr>
        </table>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Welcome to <a href="{{route("index") }}">{{ config("app.name") }}</a> {{ $mail }}, please click on the button below to confirm your email address. </p>
            </td>
          </tr>
          <!-- end copy -->
